################################################################################
# MAGNUM - FOLDER CREATOR FROM CSV
################################################################################
# Just run: .\MAGNUM_Create_Folders.ps1
################################################################################
...
# ============================================================================
$readGroup = "MAG_READ"
$dataEditGroup = "MAG_DATA_EDIT"
$aiEditGroup = "MAG_AI_EDIT"
$insightsEditGroup = "MAG_INSIGHTS_EDIT"
...
Write-Host "  MAGNUM - FOLDER CREATOR" -ForegroundColor Cyan
Write-Host "═══════════════════════════════════════`n" -ForegroundColor Cyan
