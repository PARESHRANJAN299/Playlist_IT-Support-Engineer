################################################################################
# KELLANOVA - FOLDER CREATOR FROM CSV
################################################################################
# Just run: .\KELLANOVA_Create_Folders.ps1
################################################################################
...
# LIBRARY NAME
# ============================================================================
$libraryName = "Kellanova"

# ============================================================================
# PERMISSION GROUPS
# ============================================================================
$readGroup = "KLNVA_READ"
$dataEditGroup = "KLNVA_DATA_EDIT"
$aiEditGroup = "KLNVA_AI_EDIT"
$insightsEditGroup = "KLNVA_INSIGHTS_EDIT"
...
Write-Host "  KELLANOVA - FOLDER CREATOR" -ForegroundColor Cyan
Write-Host "═══════════════════════════════════════`n" -ForegroundColor Cyan
